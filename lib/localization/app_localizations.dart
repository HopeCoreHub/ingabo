...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'English': {
      ...
      'pleaseEnterTheFinancialTransactionId': 'Please enter the Financial Transaction ID from your MTN payment confirmation message',
      'pleaseWaitForOurTeamToConfirmYourTransaction': 'Please wait for our team to confirm your transaction. This usually takes less than 10 minutes during business hours.',
      'confirmAndSubmit': 'Confirm & Submit',
      'transactionIdSubmittedSuccessfully': 'Transaction ID submitted successfully. Our team will verify and activate your account shortly.',
      ...
      '2000RWF': '2,000 RWF',
      'unlimitedTherapySessionsWithCertifiedProfessionals': 'Unlimited therapy sessions with certified professionals',
      'subscribeNow': 'Subscribe Now',
      'mtnMobileMoneyPayment': 'MTN Mobile Money Payment',
      'payWithMtnMobileMoney': 'Pay with MTN Mobile Money',
      'dialTheFollowingUssdCodeOnYourMtnPhone': 'Dial the following USSD code on your MTN phone:',
      ...
      'payEasilyWithMtnMobileMoneyAndGetInstantAccessToProfessionalTherapy': 'Pay easily with MTN Mobile Money and get instant access to professional therapy',
      'certifiedTherapists': 'Certified Therapists',
      'licensedMentalHealthProfessionals': 'Licensed mental health professionals',
      'flexibleScheduling': 'Flexible Scheduling',
      'bookSessionsAtYourConvenience': 'Book sessions at your convenience',
      'oneOnOneSessions': '1-on-1 Sessions',
      'privateConfidentialTherapySessions': 'Private, confidential therapy sessions',
      ...
      'wouldYouLikeToCallEmergencyServicesNow': 'Would you like to call emergency services now?',
      'callNow': 'Call Now',
      'cancel': 'Cancel',
    ...
    'French': {
      ...
      'pleaseEnterTheFinancialTransactionId': 'Veuillez saisir l\'ID de transaction financière de votre message de confirmation de paiement MTN',
      'pleaseWaitForOurTeamToConfirmYourTransaction': 'Veuillez patienter pendant que notre équipe confirme votre transaction. Cela prend généralement moins de 10 minutes pendant les heures de bureau.',
      'confirmAndSubmit': 'Confirmer et Soumettre',
      'transactionIdSubmittedSuccessfully': 'ID de transaction soumis avec succès. Notre équipe vérifiera et activera votre compte sous peu.',
      ...
      'dataPerformance': 'Données & Performance',
      ...
      'beTheFirstToStartConversation': 'Soyez le premier à démarrer une conversation',
      ...
      'professionalMentalHealthSupport': 'Soutien professionnel en santé mentale',
      'monthlySubscription': 'Abonnement Mensuel',
      '2000RWF': '2 000 RWF',
      'unlimitedTherapySessionsWithCertifiedProfessionals': 'Sessions de thérapie illimitées avec des professionnels certifiés',
      'subscribeNow': 'S\'abonner Maintenant',
      'mtnMobileMoneyPayment': 'Paiement par MTN Mobile Money',
      'payWithMtnMobileMoney': 'Payez avec MTN Mobile Money',
      'dialTheFollowingUssdCodeOnYourMtnPhone': 'Composez le code USSD suivant sur votre téléphone MTN:',
      'ussdCode': '*182*1*1*0780332779*2000#',
      ...
      'note': 'Note:',
      'paymentGoesDirectlyToOurTeamAt250780332779TheNumberIsRegisteredToAlineIRADUKUNDAOurChiefOperationsOfficerSheWillBeContactingYouAsSoonAsThePaymentIsReceivedForAccountActivation': 'Le paiement va directement à notre équipe au +250780332779. Le numéro est enregistré au nom d\'Aline IRADUKUNDA, notre directrice des opérations. Elle vous contactera dès que le paiement sera reçu pour l\'activation du compte.',
      'iveMadeThePayment': 'J\'ai Effectué le Paiement',
      'payEasilyWithMtnMobileMoneyAndGetInstantAccessToProfessionalTherapy': 'Payez facilement avec MTN Mobile Money et obtenez un accès instantané à une thérapie professionnelle',
      'certifiedTherapists': 'Thérapeutes Certifiés',
      'licensedMentalHealthProfessionals': 'Professionnels de la santé mentale agréés',
      'flexibleScheduling': 'Horaires Flexibles',
      'bookSessionsAtYourConvenience': 'Réservez des séances à votre convenance',
      'oneOnOneSessions': 'Sessions Individuelles',
      'privateConfidentialTherapySessions': 'Sessions de thérapie privées et confidentielles',
      ...
      'wouldYouLikeToCallEmergencyServicesNow': 'Voulez-vous appeler les services d\'urgence maintenant?',
    ...
    'Swahili': {
      ...
      'pleaseEnterTheFinancialTransactionId': 'Tafadhali ingiza Kitambulisho cha Shughuli ya Fedha kutoka ujumbe wako wa uthibitisho wa malipo wa MTN',
      'pleaseWaitForOurTeamToConfirmYourTransaction': 'Tafadhali subiri timu yetu ithibitishe muamala wako. Hii kwa kawaida huchukua chini ya dakika 10 wakati wa saa za kazi.',
      'confirmAndSubmit': 'Thibitisha na Wasilisha',
      'transactionIdSubmittedSuccessfully': 'Kitambulisho cha muamala kimewasilishwa kwa mafanikio. Timu yetu itathibitisha na kuamilisha akaunti yako hivi karibuni.',
      'pleaseEnterTransactionId': 'Tafadhali ingiza Kitambulisho cha Muamala halali',
      ...
      'dataPerformance': 'Data na Utendaji',
      ...
      '2000RWF': 'RWF 2,000',
      'unlimitedTherapySessionsWithCertifiedProfessionals': 'Vikao vya tiba visivyo na kikomo na wataalamu wenye vyeti',
      ...
      'dialTheFollowingUssdCodeOnYourMtnPhone': 'Piga namba ifuatayo ya USSD kwenye simu yako ya MTN:',
      'ussdCode': '*182*1*1*0780332779*2000#',
      ...
      'note': 'Kumbuka:',
      'paymentGoesDirectlyToOurTeamAt250780332779TheNumberIsRegisteredToAlineIRADUKUNDAOurChiefOperationsOfficerSheWillBeContactingYouAsSoonAsThePaymentIsReceivedForAccountActivation': 'Malipo huenda moja kwa moja kwa timu yetu kwenye +250780332779. Namba imesajiliwa kwa Aline IRADUKUNDA, Afisa Mkuu wa Uendeshaji. Atakuwa akiwasiliana nawe mara tu malipo yatakapopokelewa kwa uanzishaji wa akaunti.',
      'iveMadeThePayment': 'Nimefanya Malipo',
      'payEasilyWithMtnMobileMoneyAndGetInstantAccessToProfessionalTherapy': 'Ishyura byoroshye na MTN Mobile Money kandi ubone ubufasha bw\'inzobere ako kanya',
      'certifiedTherapists': 'Wataalamu Wenye Vyeti',
      'licensedMentalHealthProfessionals': 'Wataalamu wa afya ya akili wenye leseni',
      ...
      'privateConfidentialTherapySessions': 'Vikao vya tiba vya faragha na siri',
      ...
      'wouldYouLikeToCallEmergencyServicesNow': 'Ungependa kupiga simu kwa huduma za dharura sasa?',
    ...
    'Kinyarwanda': {
      ...
      'pleaseEnterTheFinancialTransactionId': 'Nyamuneka andika Nomero y\'Ubwishyu (Transaction ID) ivuye mu butumwa bwo kwemeza ubwishyu bwa MTN',
      'pleaseWaitForOurTeamToConfirmYourTransaction': 'Nyamuneka tegereza ikipe yacu kugira ngo yemeze ubwishyu bwawe. Ibi bisanzwe bifata munsi y\'iminota 10 mu masaha y\'akazi.',
      'confirmAndSubmit': 'Emeza & Ohereza',
      'transactionIdSubmittedSuccessfully': 'Nomero y\'Ubwishyu yoherejwe neza. Ikipe yacu izabyemeza kandi ikore konti yawe vuba.',
      'pleaseEnterTransactionId': 'Nyamuneka andika Nomero y\'Ubwishyu ifite agaciro',
      ...
      'languageAudio': 'Ururimi n\'Amajwi',
      'dataPerformance': 'Data n\'Imikorere',
      'lowDataMode': 'Uburyo bwa Data Nkeya',
      'imageLazyLoading': 'Kuzana Amashusho Buhoro',
      'offlineMode': 'Uburyo bwo Gukora Udafite Interineti',
      ...
      // Data & Performance
      'dataPerformance': 'Amakuru n\'Imikorere',
      'lowDataMode': 'Uburyo bw\'Amakuru Make',
      ...
      'professionalMentalHealthSupport': 'Ubufasha bw\'inzobere mu buzima bwo mu mutwe',
      'monthlySubscription': 'Kwiyandikisha kwa Buri Kwezi',
      '2000RWF': 'RWF 2,000',
      'unlimitedTherapySessionsWithCertifiedProfessionals': 'Amasaha y\'ubuvuzi adafite umupaka n\'impuguke zemewe',
      'subscribeNow': 'Iyandikishe Nonaha',
      'mtnMobileMoneyPayment': 'Kwishyura na MTN Mobile Money',
      'payWithMtnMobileMoney': 'Ishyura na MTN Mobile Money',
      'dialTheFollowingUssdCodeOnYourMtnPhone': 'Kanda kode ya USSD ikurikira kuri telefoni yawe ya MTN:',
      'ussdCode': '*182*1*1*0780332779*2000#',
      'afterPaymentYouWillReceive': 'Nyuma yo kwishyura, uzakira:',
      'immediateConfirmationMessage': 'Ubutumwa bwo kwemeza ako kanya',
      'paymentReceiptFromOurTeam': 'Inyemezabuguzi yo kwishyura ivuye mu ikipe yacu',
      'accessToTherapyBooking': 'Uburenganzira bwo kwiyandikisha ku buvuzi',
      'note': 'Icyitonderwa:',
      'paymentGoesDirectlyToOurTeamAt250780332779TheNumberIsRegisteredToAlineIRADUKUNDAOurChiefOperationsOfficerSheWillBeContactingYouAsSoonAsThePaymentIsReceivedForAccountActivation': 'Amafaranga ajya ku ikipe yacu kuri +250780332779. Nimero yanditswe kuri Aline IRADUKUNDA, Umuyobozi w\'Ibikorwa. Azakuvugisha vuba nyuma y\'uko amafaranga yakiriwe kugira ngo akore konti yawe.',
      'iveMadeThePayment': 'Nakoze Ubwishyu',
      'payEasilyWithMtnMobileMoneyAndGetInstantAccessToProfessionalTherapy': 'Ishyura byoroshye na MTN Mobile Money kandi ubone ubufasha bw\'inzobere ako kanya',
      'certifiedTherapists': 'Abavuzi Bemewe',
      'licensedMentalHealthProfessionals': 'Inzobere mu buzima bwo mu mutwe zifite impushya',
      ...
      'privateConfidentialTherapySessions': 'Amasaha y\'ubuvuzi yihariye kandi afite ibanga',
      ...
      'wouldYouLikeToCallEmergencyServicesNow': 'Urifuza guhamagara serivisi z\'ubutabazi ubu?',
  ...
  String translate(String key) {
    ...
    return _localizedValues[locale]?[key] ?? _localizedValues['English']?[key] ?? key;
  }
} 