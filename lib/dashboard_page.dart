  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Row(
        children: [
          // Sidebar
          Container(width: 250, color: Colors.white, child: _buildSidebar()),
          // Main Content
          Expanded(
            child: Padding(
            ...
            itemBuilder: (context, index) {
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                  color:
                      isSelected ? const Color(0xFFF0FDF4) : Colors.transparent,
                ...
                lineBarsData: [
                  ...
                  LineChartBarData(
                    spots: [
                      FlSpot(
                        0,
                        ((dashboardData['aiInteractions'] as int) * 0.1)
                            .toDouble(),
                      ),
                      FlSpot(
                        1,
                        ((dashboardData['aiInteractions'] as int) * 0.12)
                            .toDouble(),
                      ),
                      FlSpot(
                        2,
                        ((dashboardData['aiInteractions'] as int) * 0.15)
                            .toDouble(),
                      ),
                      FlSpot(
                        3,
                        ((dashboardData['aiInteractions'] as int) * 0.13)
                            .toDouble(),
                      ),
                      FlSpot(
                        4,
                        ((dashboardData['aiInteractions'] as int) * 0.16)
                            .toDouble(),
                      ),
                      FlSpot(
                        5,
                        ((dashboardData['aiInteractions'] as int) * 0.18)
                            .toDouble(),
                      ),
                      FlSpot(
                        6,
                        ((dashboardData['aiInteractions'] as int) * 0.2)
                            .toDouble(),
                      ),
                    ],
                    isCurved: true,
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          ...
                          height: 48,
                          decoration: BoxDecoration(
                            color: (card['color'] as Color).withValues(
                              alpha: 0.1,
                            ),
                            shape: BoxShape.circle,
                          ),
