...
// Load signing properties if present (key.properties is not committed)
...
android {
    ...
    buildTypes {
        release {
            // Use release signing if configured; otherwise fall back to debug so local builds still work
